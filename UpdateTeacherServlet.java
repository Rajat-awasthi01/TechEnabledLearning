...
public class UpdateTeacherServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String qualifctn = request.getParameter("tqualification");
            ...
            db.pstmt = db.con.prepareStatement("UPDATE teacher_mstr SET   tname = ?,  d_o_j = ?,  address = ?,  tqualification = ?,  university = ?,  course = ?,  mob = ?,  email = ?,  pswd = ? WHERE t_id = ?;");
